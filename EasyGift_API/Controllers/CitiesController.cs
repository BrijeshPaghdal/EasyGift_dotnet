...
namespace EasyGift_API.Controllers
{
    public class CitiesController : GenericController<Cities, CitiesDTO, CreateCitiesDTO, UpdateCitiesDTO>
    {
        ...
        [HttpGet("{cityName}/Products")]
        [ProducesResponseType(StatusCodes.Status200OK)]
        [ProducesResponseType(StatusCodes.Status201Created)]
        [ProducesResponseType(StatusCodes.Status400BadRequest)]
        [ProducesResponseType(StatusCodes.Status500InternalServerError)]
        public async Task<ActionResult<APIResponse>> GetProductsByCity(string cityName = "null", [FromQuery]string CategoryName= "null")
        {
            try
            {

                dynamic datas = await _db.GetProductsByCity(cityName,CategoryName);
                ...
                return Ok(CustomMethods<Cities>.ResponseBody(HttpStatusCode.OK, false, Result: datas));
            }
            catch (Exception ex)
            {
                _response.IsSuccess = false;
