    ...
    <div class="row">
      <div class="col-lg-3 col-sm-6">
        <div class="counter-box text-center white">
          ...
          <h3 class="m-b-10">
            <?php
              $GetActiveCustomerUrl= $url."api/EasyGift/Customer?filter=CustomerStatus=1";
              $response = fetchRequest($GetActiveCustomerUrl);
      ...
      <div class="col-lg-3 col-sm-6">
        <div class="counter-box text-center white">
          ...
          <h3 class="m-b-10">
            <?php
               $GetActiveSellerUrl= $url."api/EasyGift/Seller?filter=SellerStatus=1";
               $response = fetchRequest($GetActiveSellerUrl);
               if($response['statusCode']==200)
               {
                 echo count($response['result']);
               }
